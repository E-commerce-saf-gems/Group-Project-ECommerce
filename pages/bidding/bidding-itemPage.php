                            ...
                            <form method="post" action="">
                                <div class="bid-input-container">
                                    <input type="number" id="bid_amount" name="bid_amount"
                                        placeholder="Enter your bid amount" min="<?php echo $highestBid + 1000; ?>"
                                        value="<?php echo $highestBid + 1000; ?>" required>
                                    <div class="increment-buttons">
                                        <button type="button" class="increment-btn" onclick="incrementBid(1000)">+Rs.
                                            1,000</button>
                                        <button type="button" class="increment-btn" onclick="incrementBid(10000)">+Rs.
                                            10,000</button>
                                    </div>
                                </div>
