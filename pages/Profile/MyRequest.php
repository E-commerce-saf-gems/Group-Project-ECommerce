    ...
    <div class="profile-container profile-h1">
        <div class="profile-sidebar">
            ...
            <ul>
                ...
                <li><a href="MyRequest.html" class="active">Requests</a></li>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                            ...
                                            <td class='actions'>
                                                <a href='./editGemRequest.html?id=" . $row['request_id'] . "' class='btn'><i class='bx bx-pencil'></i></a>
                                                <a href='./viewGemRequest.html?id=" . $row['request_id'] . "' class='btn'><i class='bx bx-eye'></i></a>
